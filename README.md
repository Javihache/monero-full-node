...
`docker run -tid --restart=always --mount type=bind,source=/home/$USER/.bitmonero,target=/home/monero/.bitmonero -p 18080:18080 -p 18081:18081 --prune-blockchain --name=monero javihache/monero-full-node`
